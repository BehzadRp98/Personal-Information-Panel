...
!function (e, t, n, o) {
    ...
    e.extend(i.prototype, {
        storeData: function (t, n) {
            ...
            n = n || 0, t.each(function (t, i) {
                var a = e(i), r = a.width(), s = a.height();
                a.data("cbp", {
                    index: n + t,
                    indexInitial: n + t,
            ...
            var i, a, r;
            if (t = t || "", !(e.length && e.length < 1)) for (e.length === o && (e = [e]), a = e.length - 1; a >= 0; a--) {
            ...
            requestAnimationFrame(function () {
                var i = t.find("img").map(function (t, n) {
                    if (n.hasAttribute("width") && n.hasAttribute("height")) {
                        ...
                        if (null === o.checkSrc(n)) o.removeAttrImage(n); else {
                            var i = e("<img>");
            ...
            "responsive" === t.options.gridAdjustment ? t.responsiveLayout() : (t.blocks.removeAttr("style"), t.blocks.each(function (n, o) {
                var i = e(o).data("cbp"), a = o.getBoundingClientRect(), r = t.columnWidthTruncate(a.right - a.right),
            ...
            t.blocks.each(function (t, o) {
                e.each(e(o).find("img").filter("[width][height]"), function (t, o) {
                    ...
                    var a = parseInt(o.getAttribute("width"), 10), r = parseInt(o.getAttribute("height"), 10),
                ...
                var i = e(o).data("cbp"), a = o.getBoundingClientRect(), r = Math.round(a.bottom - a.top);
            ...
            var t, n = this, a = Math.max(n.freeSpaces.slice(-1)[0].topStart - n.options.gapHorizontal, 0);
            "alignCenter" === n.options.gridAdjustment && (t = 0, n.blocksOn.each(function (n, o) {
                var i = e(o).data("cbp"), a = i.right + i.width;
                a > t && (t = a)
            ...
            a.wrapInner(t, "cbp-item-wrapper"), a.$ul[o](t.addClass("cbp-item-loading").css({
                ...
                if (a.$obj.addClass("cbp-updateItems"), "append" === o) a.storeData(t, a.blocks.length), e.merge(a.blocks, t); else {
                    a.storeData(t);
                    var n = t.length;
...
}(jQuery, window, document), function (e, t, n, o) {
    "use strict";
    ...
    e.extend(i.prototype, {
        mosaicLayoutReset: function () {
            ...
            return e.each(t.freeSpaces, function (o, i) {
                var a = i.rightEnd - i.rightStart, r = i.topEnd - i.topStart;
                return t.blocksOn.each(function (t, s) {
                    var l = e(s).data("cbp");
                    if (!0 !== l.pack) return l.widthAndGap <= a && l.heightAndGap <= r ? (l.pack = !0, n = {
                        spaceIndex: o,
                        dataBlock: l
                    }, l.rightNew = i.rightStart, l.topNew = i.topStart, !1) : void 0
                }), !t.blocksAreSorted && t.options.sortByDimension && o > 0 ? (n = null, !1) : null === n && void 0
            }), n
        }, generateF1F2: function (e, t) {
            var n = this, o = n.freeSpaces[e], i = {
                rightStart: o.rightStart + t.widthAndGap,
                rightEnd: o.rightEnd,
                topStart: o.topStart,
                topEnd: o.topEnd
            }, a = {
                rightStart: o.rightStart,
                rightEnd: o.rightEnd,
            ...
            var n = {
                rightStart: t.rightNew,
                rightEnd: t.rightNew + t.widthAndGap,
                topStart: t.topNew,
            ...
            var o = Math.max(e.rightStart, n.rightStart), i = Math.min(e.rightEnd, n.rightEnd),
                a = Math.max(e.topStart, n.topStart), r = Math.min(e.topEnd, n.topEnd);
            ...
            e.rightEnd !== t.rightEnd && n.push({
                rightStart: t.rightEnd,
                rightEnd: e.rightEnd,
                topStart: e.topStart,
                topEnd: e.topEnd
            })
            ...
            e.rightStart !== t.rightStart && n.push({
                rightStart: e.rightStart,
                rightEnd: t.rightStart,
                topStart: e.topStart,
                topEnd: e.topEnd
            })
            ...
            o = void 0 === o ? "rightNew" : o, i = void 0 === i ? 1 : -1, t.sort(function (t, a) {
                var r = e(t).data("cbp"), s = e(a).data("cbp");
    ...
    "use strict";
    var i = e.fn.cubeportfolio.constructor, a = e(t);
    i["private"] = {
        publicEvents: function (t, n, o) {
            ...
            var e, n, o = i["private"], a = navigator.appVersion;
            ...
            var t, o = "Webkit" + e.charAt(0).toUpperCase() + e.slice(1), i = n.createElement("div");
    ...
    i["public"] = {
        init: function (e, t) {
            ...
            e.isFunction(n) && o.registerEvent("showCounterFinish", n, !0), o.elems = t, t.each(function () {
                var t = e(this), n = o.blocks.filter(t.data("filter")).length;
                t.find(".cbp-filter-counter").text(n)
            }), o.triggerEvent("showCounterFinish", t)
        }, appendItems: function (e, t) {
            i["public"].append.call(this, e, t)
        }, append: function (t, n) {
            var o = i["private"].checkInstance.call(this, "append"), a = e(t).filter(".cbp-item");
            ...
            var o = i["private"].checkInstance.call(this, "prepend"), a = e(t).filter(".cbp-item");
            o.isAnimating || a.length < 1 ? e.isFunction(n) && n.call(o, a) : (o.isAnimating = !0, o.singlePageInline && o.singlePageInline.isOpen ? o.singlePageInline.close("promise", {
                callback: function () {
            ...
            var o = i["private"].checkInstance.call(this, "remove"), a = e(t).filter(".cbp-item");
            o.isAnimating || a.length < 1 ? e.isFunction(n) && n.call(o, a) : (o.isAnimating = !0, o.singlePageInline && o.singlePageInline.isOpen ? o.singlePageInline.close("promise", {
                callback: function () {
                    o.removeItems(a, n)
                }
    ...
    e.extend(i.prototype, {
        updateSliderPagination: function () {
            ...
            var t = this, n = Math.min(e.index() * t.cols, t.blocksOn.length - t.cols);
            n !== t.sliderActive && (t.sliderActive = n, t.goToSlider())
        }, jumpDragToSlider: function (e) {
            var t, n, o, i = this, a = e > 0;
            ...
            var e = this, t = -e.sliderActive * e.columnWidth;
            ...
            function s(e) {
                ...
                var t = f - u;
                u < 0 && u < f ? t = (f - u) / 5 : u > 0 && f - u < -g && (t = (g + f - u) / 5 - g), i["private"].modernBrowser ? b.$ul[0].style[i["private"].transform] = "translate3d(" + t + "px, 0px, 0)" : b.$ul[0].style.right = t + "px"
            }
            ...
            var c, u, d, f, g, h, b = this, v = e(n), m = !1, y = {}, w = !1;
            b.isDrag = !1, "ontouchstart" in t || navigator.maxTouchPoints > 0 || navigator.msMaxTouchPoints > 0 ? (y = {
                start: "touchstart.cbp",
                move: "touchmove.cbp",
                end: "touchend.cbp"
            }, w = !0) : y = {start: "mousedown.cbp", move: "mousemove.cbp", end: "mouseup.cbp"}, b.$ul.on(y.start, a)
    ...
    i.prototype.filterLayout = function () {
        ...
        var n = this, o = n.$ul[0].cloneNode(!0);
        o.setAttribute("class", "cbp-wrapper-helper"), n.wrapper[0].insertBefore(o, n.$ul[0]), requestAnimationFrame(function () {
            n.$obj.addClass("cbp-animation-" + n.options.animationType), n.blocksOff.addClass("cbp-item-off"), n.blocksOn.removeClass("cbp-item-off").each(function (t, o) {
                var i = e(o).data("cbp");
                i.right = i.rightNew, i.top = i.topNew, o.style.right = i.right + "px", o.style.top = i.top + "px", "sequentially" === n.options.animationType && (i.wrapper[0].style[a["private"].animationDelay] = 60 * t + "ms")
    ...
    i.prototype.filterLayout = function () {
        ...
        var n = this, o = n.$ul.clone(!0, !0);
        o[0].setAttribute("class", "cbp-wrapper-helper"), n.wrapper[0].insertBefore(o[0], n.$ul[0]);
        var i = o.find(".cbp-item").not(".cbp-item-off");
        n.blocksAreSorted && n.sortBlocks(i, "top", "right"), i.children(".cbp-item-wrapper").each(function (e, t) {
            ...
            var o = n.blocksOn.length, r = i.length;
        ...
        this.parent = t, t.registerEvent("initFinish", function () {
            t.$obj.on("click.cbp", ".cbp-caption-defaultWrap", function (n) {
                if (n.preventDefault(), !t.isAnimating) {
                    t.isAnimating = !0;
                    var o = e(this), i = o.next(), a = o.parent(),
                        r = {position: "relative", height: i.outerHeight(!0)}, s = {position: "relative", height: 0};
    ...
    i.prototype.registerFilter = function () {
        var t = this, n = t.parent, o = n.defaultFilter.split("|");
        t.wrap = t.filters.find(".cbp-l-filters-dropdownWrap").on({
            ...
            var r = e(a), s = "*", l = r.find(".cbp-filter-item"), p = {};
    ...
    function i(t) {
        var n = t.options.gapVertical, o = t.options.gapHorizontal;
    ...
    function a(e) {
        var t = this;
        e.hasClass("cbp-slider-inline-ready") || (e.addClass("cbp-slider-inline-ready"), t.items = e.find(".cbp-slider-wrapper").children(".cbp-slider-item"), t.active = t.items.filter(".cbp-slider-item--active").index(), t.total = t.items.length - 1, t.updateright(), e.find(".cbp-slider-next").on("click.cbp", function (e) {
    ...
    var r = {}, s = e.fn.cubeportfolio.constructor;
    a.prototype.updateright = function () {
        ...
        t.parent.$obj.find(".cbp-slider-inline").not(".cbp-slider-inline-ready").each(function (n, o) {
            var i = e(o), r = i.find(".cbp-slider-item--active").find("img")[0];
    ...
    var a = {loadingClass: "cbp-lazyload", threshold: 400}, r = e.fn.cubeportfolio.constructor, s = e(t);
    r["private"].lazyLoadScroll = new r["private"].publicEvents("scroll.cbplazyLoad", 50), i.prototype.loadImages = function () {
        var t = this, n = t.parent.$obj.find("img").filter("[data-cbp-src]");
        ...
        var t = this, n = e.getBoundingClientRect(), o = n.bottom + t.options.threshold,
    ...
    var a = {element: "", action: "click", loadItems: 3}, r = e.fn.cubeportfolio.constructor;
    i.prototype.populateItems = function () {
        ...
        var n = this, o = [], i = n.parent.defaultFilter, a = 0;
    ...
    var a = e.fn.cubeportfolio.constructor, r = {delay: 0}, s = {
        init: function (t, o) {
            var i, a = this;
            if (a.cubeportfolio = t, a.type = o, a.isOpen = !1, a.options = a.cubeportfolio.options, "lightbox" === o && (a.cubeportfolio.registerEvent("resizeWindow", function () {
                ...
                if (a.createMarkup(), "singlePage" === o) {
                    if (a.cubeportfolio.registerEvent("resizeWindow", function () {
                        ...
                        var s = a.url.split("#cbp="), l = s.shift();
                        if (e.each(s, function (t, n) {
                            ...
                            a.url = l;
                            var p = i, c = p.attr("data-cbp-singlePage"), u = [];
            ...
            var t = this, o = "";
            "singlePage" === t.type && "right" !== t.options.singlePageAnimation && (o = " cbp-popup-singlePage-" + t.options.singlePageAnimation), t.wrap = e("<div/>", {
            ...
            }), "singlePage" === t.type ? (t.contentWrap = e("<div/>", {"class": "cbp-popup-content-wrap"}).appendTo(t.wrap), "ios" === a["private"].browser && t.contentWrap.css("overflow", "auto"), t.content = e("<div/>", {"class": "cbp-popup-content"}).appendTo(t.contentWrap)) : t.content = e("<div/>", {"class": "cbp-popup-content"}).appendTo(t.wrap), e("<div/>", {"class": "cbp-popup-loadingBox"}).appendTo(t.wrap), "ie8" === a["private"].browser && (t.bg = e("<div/>", {
                "class": "cbp-popup-ie8bg",
                "data-action": "lightbox" === t.type ? "close" : ""
            }).appendTo(t.wrap)), "singlePage" === t.type && !1 === t.options.singlePageStickyNavigation ? t.navigationWrap = e("<div/>", {"class": "cbp-popup-navigation-wrap"}).appendTo(t.contentWrap) : t.navigationWrap = e("<div/>", {"class": "cbp-popup-navigation-wrap"}).appendTo(t.wrap), t.navigation = e("<div/>", {"class": "cbp-popup-navigation"}).appendTo(t.navigationWrap), t.closeButton = e("<div/>", {
                ...
                e.preventDefault();
                var o, i, a = t.dataArray.length, r = this.getAttribute("href");
                for (o = 0; o < a; o++) if (t.dataArray[o].url === r) {
                    i = o;
                    break
                }
                if (void 0 === i) {
            ...
            }), t.content = e("<div/>", {"class": "cbp-popup-content"}).appendTo(t.wrap), t.navigation = e("<div/>", {"class": "cbp-popup-navigation"}).appendTo(t.wrap), t.closeButton = e("<div/>", {
                "class": "cbp-popup-close",
                title: "Close (Esc arrow key)",
                "data-action": "close"
            ...
            if (!s.isOpen) {
                ...
                e.each(o, function (t, n) {
                    var o, i = n.getAttribute("href"), r = i, l = "isImage";
                    if (-1 === e.inArray(i, c)) {
                        if (a === i) s.current = p; else if (!s.options.lightboxGallery) return;
            ...
            if (!s.isOpen) {
                ...
                if (e.each(o, function (t, n) {
                    ...
                    c.addEventListener("touchstart", function () {
                        var e = c.scrollTop, t = c.scrollHeight, n = e + c.offsetHeight;
            ...
            if (s = e(o).closest(".cbp-item")[0], n.each(function (e, t) {
                ...
                url: a,
                element: o
            }, e(l.dataArray[l.current].element).parents(".cbp-item").addClass("cbp-singlePageInline-active"), l.counterTotal = n.length, l.wrap.insertBefore(l.cubeportfolio.wrapper), l.topDifference = 0, "top" === l.options.singlePageInlinePosition) l.blocksToMove = n, l.top = 0; else if ("bottom" === l.options.singlePageInlinePosition) l.blocksToMove = e(), l.top = l.cubeportfolio.height; else if ("above" === l.options.singlePageInlinePosition) {
                var p = e(n[l.current]), c = (u = p.data("cbp").top) + p.height();
                l.top = u, l.blocksToMove = e(), n.each(function (t, n) {
                    var o = e(n), i = o.data("cbp").top, a = i + o.height();
                ...
                var u = (p = e(n[l.current])).data("cbp").top, c = u + p.height();
                l.top = c, l.blocksToMove = e(), n.each(function (t, n) {
                    var o = e(n), i = o.height(), a = o.data("cbp").top, r = a + i;
            ...
            if (l.wrap[0].style.height = l.wrap.outerHeight(!0) + "px", l.deferredInline = e.Deferred(), l.options.singlePageInlineInFocus) {
                ...
                l.scrollTop !== d ? e("html,body").animate({scrollTop: d}, 350).promise().then(function () {
            ...
            var t = this, o = 0, i = function (a) {
                var r = n.createElement("script"), s = a.src;
            ...
            e.length && !e.attr("onclick") && e.attr("onclick", "window.open('http://www.facebook.com/sharer.php?u=" + encodeURIComponent(t.location.href) + "', '_blank', 'top=100,right=100,toolbar=0,status=0,width=620,height=400'); return false;")
        }, createTwitterShare: function (e) {
            e.length && !e.attr("onclick") && e.attr("onclick", "window.open('https://twitter.com/intent/tweet?source=" + encodeURIComponent(t.location.href) + "&text=" + encodeURIComponent(n.title) + "', '_blank', 'top=100,right=100,toolbar=0,status=0,width=620,height=300'); return false;")
        }, createGooglePlusShare: function (e) {
            e.length && !e.attr("onclick") && e.attr("onclick", "window.open('https://plus.google.com/share?url=" + encodeURIComponent(t.location.href) + "', '_blank', 'top=100,right=100,toolbar=0,status=0,width=620,height=450'); return false;")
        }, createPinterestShare: function (e) {
            if (e.length && !e.attr("onclick")) {
                var n = "", o = this.content.find("img")[0];
                o && (n = o.src), e.attr("onclick", "window.open('http://pinterest.com/pin/create/button/?url=" + encodeURIComponent(t.location.href) + "&media=" + n + "', '_blank', 'top=100,right=100,toolbar=0,status=0,width=620,height=400'); return false;")
            }
            ...
            function r() {
                var o = e(t).scrollTop();
                s.resetWrap(), e(t).scrollTop(o), s.options.singlePageInlineInFocus && "promise" !== n ? e("html,body").animate({scrollTop: s.scrollTop}, 350).promise().then(function () {
                    i()
                }) : i()
            }
            ...
            if (this.isOpen) {
                var n = this.content.find("img"), o = n.parent(),
    ...
    i.prototype.run = function () {
        var t = this, o = t.parent, i = e(n.body);
        o.lightbox = null, o.options.lightboxDelegate && !p && (p = !0, o.lightbox = Object.create(s), o.lightbox.init(o, "lightbox"), i.on("click.cbp", o.options.lightboxDelegate, function (n) {
            n.preventDefault();
            var i = e(this), a = i.attr("data-cbp-lightbox"), r = t.detectScope(i), s = r.data("cubeportfolio"), l = [];
            ...
            n.preventDefault();
            var i = e(this), a = i.attr("data-cbp-singlePage"), r = t.detectScope(i), s = r.data("cubeportfolio"),
                l = [];
            s ? s.blocksOn.each(function (t, n) {
                var i = e(n);
            ...
            t.preventDefault();
            var n = e.data(this, "cbp-locked"), i = e.data(this, "cbp-locked", +new Date);
    ...
    i.prototype.runEvent = function (t) {
        var n = this, o = t.val(), i = t.data("searchData"), a = new RegExp(o, "i");
    ...
    var a = {pagination: "", paginationClass: "cbp-pagination-active"}, r = e.fn.cubeportfolio.constructor;
    i.prototype.sliderMarkup = function () {
        var t = this;
        t.sliderStopEvents = !1, t.sliderActive = 0, t.$obj.one("initComplete.cbp", function () {
            t.$obj.addClass("cbp-mode-slider")
        }), t.nav = e("<div/>", {"class": "cbp-nav"}), t.nav.on("click.cbp", "[data-slider-action]", function (n) {
            if (n.preventDefault(), n.stopImmediatePropagation(), n.stopPropagation(), !t.sliderStopEvents) {
                var o = e(this), i = o.attr("data-slider-action");
                t[i + "Slider"] && t[i + "Slider"](o)
            }
        }), t.options.showNavigation && (t.controls = e("<div/>", {"class": "cbp-nav-controls"}), t.navPrev = e("<div/>", {
            "class": "cbp-nav-prev",
            "data-slider-action": "prev"
        }).appendTo(t.controls), t.navNext = e("<div/>", {
            "class": "cbp-nav-next",
            "data-slider-action": "next"
        }).appendTo(t.controls), t.controls.appendTo(t.nav)), t.options.showPagination && (t.navPagination = e("<div/>", {"class": "cbp-nav-pagination"}).appendTo(t.nav)), (t.controls || t.navPagination) && t.nav.appendTo(t.$obj), t.updateSliderPagination(), t.options.auto && (t.options.autoPauseOnHover && (t.mouseIsEntered = !1, t.$obj.on("mouseenter.cbp", function (e) {
    ...
    var a = {element: ""}, r = e.fn.cubeportfolio.constructor;
    i.prototype.processSort = function () {
        var t = this, n = t.parent, o = (c = t.target).hasAttribute("data-sort"), i = c.hasAttribute("data-sortBy");
        if (o && i) t.sort = c.getAttribute("data-sort"), t.sortBy = c.getAttribute("data-sortBy"); else if (o) t.sort = c.getAttribute("data-sort"); else {
            if (!i) return;
            t.sortBy = c.getAttribute("data-sortBy")
        }
        var a = t.sortBy.split(":"), r = "string", s = 1;
        if ("int" === a[0] ? r = "int" : "float" === a[0] && (r = "float"), "desc" === a[1] && (s = -1), t.sort) {
            var l = [];
            n.blocks.each(function (n, o) {
                var i = e(o), a = i.find(t.sort).text();
                "int" === r && (a = parseInt(a, 10)), "float" === r && (a = parseFloat(a, 10)), l.push({
                    sortText: a,
                    data: i.data("cbp")
                })
            }), l.sort(function (e, t) {
                var n = e.sortText, o = t.sortText;
        ...
        var c = e(t.target), u = e(t.target).parent();
