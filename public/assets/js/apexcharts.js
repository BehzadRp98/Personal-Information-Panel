...
! function (t, e) {
    ...
    var x = {
            ...
            options: {
                ...
                shortDays: ["شنبه", "یکشنبه", "دوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه"],
                toolbar: {
                            ...
                            custom: function (t) {
                                ...
                                if (void 0 === r.config.tooltip.x.formatter)
                                    if ("datetime" === r.config.xaxis.type) {
                                        var g = new v(e);
                                        c = g.formatDate(new Date(o), r.config.tooltip.x.format, !0, !0), d = g.formatDate(new Date(l), r.config.tooltip.x.format, !0, !0)
                                    } else c = o, d = l;
                                else c = r.config.tooltip.x.formatter(o), d = r.config.tooltip.x.formatter(l);
                                return '<div class="apexcharts-tooltip-rangebar"><div> <span class="series-name" style="color: ' + u + '">' + (r.config.series[i].name ? r.config.series[i].name : "") + '</span></div><div> <span class="category">' + h + ': </span> <span class="value start-value">' + c + '</span> <span class="separator">-</span> <span class="value end-value">' + d + "</span></div></div>"
                            }
                        },
                        xaxis: {
                            tooltip: {
                ...
                value: function (t, e, i, a, s, n, r) {
                    ...
                    if (o.globals.dataChanged)
                        if (this.dynamicAnim) {
                            ...
                            for (var T = 0; T < o.globals.collapsedSeries.length; T++) o.globals.collapsedSeries[T].index === s && (z = 1, a = 0);
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    if (!(Array.isArray(e.config.dataLabels.enabledOnSeries) && e.config.dataLabels.enabledOnSeries.indexOf(n) < 0)) {
                        ...
                        u && (f = this.dataLabelsCorrection(a, s, o, n, r, d, parseInt(c.style.fontSize))), e.globals.zoomed || (a = f.x, s = f.y), f.textRects && (a + f.textRects.width < 10 || a > e.globals.gridWidth + 10) && (o = "");
                        var x = e.globals.dataLabels.style.colors[n];
                        if ("bar" !== e.config.chart.type && "rangeBar" !== e.config.chart.type || !e.config.plotOptions.bar.distributed || (x = e.globals.dataLabels.style.colors[r]), f.drawnextLabel) {
                            var b = i.drawText({
                                width: 100,
        ...
        T = function () {
            function t(i, a) {
                e(this, t), this.ctx = i, this.w = i.w;
                var s = this.w;
                this.barOptions = s.config.plotOptions.bar, this.isHorizontal = this.barOptions.horizontal, this.strokeWidth = s.config.stroke.width, this.isNullValue = !1, this.isTimelineBar = "datetime" === s.config.xaxis.type && s.globals.seriesRangeBarTimeline.length, this.xyRatios = a, null !== this.xyRatios && (this.xRatio = a.xRatio, this.yRatio = a.yRatio, this.invertedXRatio = a.invertedXRatio, this.invertedYRatio = a.invertedYRatio, this.baseLineY = a.baseLineY, this.baseLineInvertedY = a.baseLineInvertedY), this.yaxisIndex = 0, this.seriesLen = 0
            }
            return a(t, [{
                key: "draw",
                value: function (t, e) {
                    ...
                    for (var r = 0, o = 0; r < t.length; r++, o++) {
                        ...
                        for (var P = a.group({
                            ...
                            }), z = 0, T = i.globals.dataPoints; z < i.globals.dataPoints; z++, T--) {
                            ...
                            this.isHorizontal ? (E = this.drawBarPaths({
                                ...
                                strokeWidth: A,
                                elSeries: k
                            }), S = this.series[r][z] / this.yRatio[this.yaxisIndex]), g = E.pathTo, f = E.pathFrom, b = E.y, x = E.x, z > 0 && v.push(x + C / 2), m.push(b);
                ...
                value: function (t) {
                    var e = t.realIndex,
                        ...
                        A = this.w,
                        S = new p(this.ctx);
                    a || (a = this.barOptions.distributed ? A.globals.stroke.colors[s] : A.globals.stroke.colors[e]), A.config.series[n].data[s] && A.config.series[n].data[s].strokeColor && (a = A.config.series[n].data[s].strokeColor), this.isNullValue && (i = "none");
                    ...
                    L.attr("clip-path", "url(#gridRectMask".concat(A.globals.cuid, ")")), void 0 !== u && void 0 !== f && (L.attr("data-range-y1", u), L.attr("data-range-y2", f)), new g(this.ctx).setSelectionFilter(L, e, s), h.add(L);
                ...
                value: function (t) {
                    var e = t.x,
                        ...
                        m = e + parseFloat(c * u),
                        v = i + parseFloat(h * u);
                    f.globals.isXNumeric && !f.globals.isBarHorizontal && (m = e + parseFloat(c * (u + 1)), v = i + parseFloat(h * (u + 1)) - b);
                    var y = e,
                        w = i,
                        k = {},
                    ...
                    return f.config.dataLabels.enabled && (P = x.getTextRects(f.globals.yLabelFormatters[0](f.globals.maxY), parseFloat(A.style.fontSize))), k = this.isHorizontal ? this.calculateBarsDataLabelsPosition({
                        x: e,
                        y: i,
                        i: n,
                        j: r,
                ...
                value: function (t) {
                    ...
                    if (c.enabled && !m) {
                        ...
                        if ("vertical" === d.config.plotOptions.bar.dataLabels.orientation && ("top" == w && (c.textAnchor = y ? "end" : "start"), "center" == w && (c.textAnchor = "middle"), "bottom" == w && (c.textAnchor = y ? "end" : "start")), this.isTimelineBar && this.barOptions.dataLabels.hideOverflowingLabels) h < f.getTextRects(v, parseFloat(c.style.fontSize)).width && (v = "");
                        d.config.chart.stacked && this.barOptions.dataLabels.hideOverflowingLabels && (this.isHorizontal ? ((h = this.series[s][n] / this.yRatio[this.yaxisIndex]) > 0 && o.width / 1.6 > h || h < 0 && o.width / 1.6 < h) && (v = "") : (l = this.series[s][n] / this.yRatio[this.yaxisIndex], o.height / 1.6 > l && (v = "")));
                        var k = r({}, c);
        ...
        E = function (t) {
            ...
            return o(i, T), a(i, [{
                ...
                value: function (t, e) {
                    var i = this.w;
                    this.graphics = new p(this.ctx), this.fill = new C(this.ctx), this.bar = new T(this.ctx, this.xyRatios);
                    ...
                    for (var n = this.graphics.group({
                        ...
                        for (var E = 0; E < i.globals.dataPoints; E++) {
                            ...
                            this.isHorizontal ? (M = this.drawBarPaths({
                                ...
                                yDivision: f,
                                elSeries: k
                            }), P = this.series[l][E] / this.invertedYRatio) : (M = this.drawColumnPaths({
                                indexes: {
                                    i: l,
                                    j: E,
                                    realIndex: y,
                                ...
                                strokeWidth: S,
                                elSeries: k
                            }), L = this.series[l][E] / this.yRatio[this.yaxisIndex]), c = M.pathTo, d = M.pathFrom, o = M.y, r = M.x, m.push(r), v.push(o);
                ...
                value: function (t, e) {
                    ...
                    for (var r = a.group({
                        ...
                        for (var P = a.group({
                            ...
                            var E, M = this.drawCandleStickPaths({
                                indexes: {
                                    i: o,
                                    j: z,
                                    realIndex: v,
                            ...
                            d = M.pathTo, g = M.pathFrom, x = M.y, f = M.x, E = M.color, z > 0 && m.push(f + A / 2), b.push(x);
                            var I = s.fillPath({
                                    seriesNumber: v,
                                    color: E,
                                    value: t[o][z]
            ...
            return o(i, T), a(i, [{
                    ...
                    for (var n = a.group({
                        ...
                        for (var S = a.group({
                            ...
                            for (var I = 0; I < z; I++) {
                                ...
                                } else w = (X = this.drawRangeColumnPaths({
                                    indexes: {
                                        i: r,
                                        j: L,
                                        realIndex: m,
                                ...
                                var O = null;
                                i.config.series[r].data[L] && i.config.series[r].data[L].fillColor && (O = i.config.series[r].data[L].fillColor);
                                var N = s.fillPath({
                                        seriesNumber: m,
                                        color: O
                                    }),
                ...
                value: function (t) {
                    var e, i, a = t.indexes,
                        ...
                        x = (a.i, a.j),
                        b = a.realIndex;
                    e = u + n / this.invertedYRatio, i = u + r / this.invertedYRatio, f.move(u, d), h = f.move(u, d), g.globals.previousPaths.length > 0 && (h = this.getPathFrom(b, x));
                    var m = Math.abs(i - e);
                    return l = f.move(e, d) + f.line(i, d) + f.line(i, d + c) + f.line(e, d + c) + f.line(e, d), h = h + f.line(e, d) + f.line(e, d + c) + f.line(e, d + c) + f.line(e, d), g.globals.isXNumeric || (s += o), {
                        pathTo: l,
                        pathFrom: h,
                        barWidth: m,
                        x: i,
        ...
        W = function () {
            ...
            return a(t, [{
                ...
                value: function () {
                    var t, e = this.w;
                    this.timescaleLabels = e.globals.timelineLabels.slice(), e.globals.invertedTimelineLabels.length && (this.timescaleLabels = e.globals.invertedTimelineLabels.slice());
            ...
            return a(t, [{
                ...
                value: function () {
                    var t = this.w,
                        ...
                        n = "middle";
                    if (t.globals.noData = !0, t.globals.animationEnded = !0, "left" === e.align ? (a = 10, n = "start") : "right" === e.align && (a = t.globals.svgWidth - 10, n = "end"), "top" === e.verticalAlign ? s = 50 : "bottom" === e.verticalAlign && (s = t.globals.svgHeight - 50), a += e.offsetX, s = s + parseInt(e.style.fontSize) + 2 + e.offsetY, void 0 !== e.text && "" !== e.text) {
                        var r = i.drawText({
                            x: a,
                            y: s,
                            text: e.text,
            ...
            return a(t, [{
                ...
                value: function (t, e, i) {
                    ...
                    for (var d = this.xyRatios.zRatio, g = this.xyRatios.xRatio, f = this.xyRatios.baseLineY, x = [], b = [], m = 0, v = 0; v < t.length; v++) {
                        ...
                        var S = [],
                            P = [],
                            T = a.globals.gridHeight - f[this.yaxisIndex] - (this.isReversed ? a.globals.gridHeight : 0) + (this.isReversed ? 2 * f[this.yaxisIndex] : 0),
                            E = T;
                        T > a.globals.gridHeight && (E = a.globals.gridHeight), m = k / 2;
                        var M = a.globals.padHorizontal + m,
                            I = 1;
                        a.globals.isXNumeric && a.globals.seriesX.length > 0 && (M = (a.globals.seriesX[A][0] - a.globals.minX) / g), P.push(M);
                        var X = void 0,
                            Y = void 0,
                            F = void 0,
                            R = void 0,
                        ...
                        if (F = s.move(-1, T) + s.line(-1, T), R = s.move(-1, T) + s.line(-1, T), a.globals.previousPaths.length > 0) {
                        ...
                        for (var $ = a.globals.dataPoints > 1 ? a.globals.dataPoints - 1 : a.globals.dataPoints, J = 0; J < $; J++) {
                            if (a.globals.isXNumeric) {
                                ...
                                void 0 === a.globals.seriesX[A][J + 1] && (Q = a.globals.seriesX[A][$ - 1]), M = (Q - a.globals.minX) / g
                            } else M += k;
                            var K = u.isNumber(a.globals.minYArr[A]) ? a.globals.minYArr[A] : a.globals.minY;
                            a.config.chart.stacked ? (U = v > 0 && a.globals.collapsedSeries.length < a.config.series.length - 1 ? b[v - 1][J + 1] : T, I = void 0 === t[v][J + 1] || null === t[v][J + 1] ? U - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : U - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0)) : I = void 0 === t[v][J + 1] || null === t[v][J + 1] ? T - K / c[this.yaxisIndex] + 2 * (this.isReversed ? K / c[this.yaxisIndex] : 0) : T - t[v][J + 1] / c[this.yaxisIndex] + 2 * (this.isReversed ? t[v][J + 1] / c[this.yaxisIndex] : 0), P.push(M), S.push(I);
                            ...
                            O = tt.areaPaths, D = tt.linePaths, V = tt.pX, G = tt.pY, Y = tt.areaPath, X = tt.linePath, this.appendPathFrom && (F += s.line(M, T), R += s.line(M, T));
        ...
        j = function () {
            ...
            return a(t, [{
                ...
                value: function (t, e, i) {
                    ...
                    var r = Math.abs(i - e);
                    n.logarithmic && r <= 5 && (a.invalidLogScale = !0), n.logarithmic && r > 5 ? (a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(t, e, i, n.tickAmount ? n.tickAmount : Math.floor(Math.log10(i)))) : i !== -Number.MAX_VALUE && u.isNumber(i) ? (a.allSeriesCollapsed = !1, void 0 === n.min && void 0 === n.max || n.forceNiceScale ? a.yAxisScale[t] = this.niceScale(e, i, r, t, n.tickAmount ? n.tickAmount : r < 5 && r > 1 ? r + 1 : 5) : a.yAxisScale[t] = this.linearScale(e, i, n.tickAmount)) : a.yAxisScale[t] = this.linearScale(0, 5, 5)
                }
            }, {
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    var l = n.series,
                        h = l,
                        c = l;
                    "candlestick" === s.chart.type ? (h = n.seriesCandleL, c = n.seriesCandleH) : n.isRangeData && (h = n.seriesRangeStart, c = n.seriesRangeEnd);
                    for (var d = t; d < a; d++) {
                        n.dataPoints = Math.max(n.dataPoints, l[d].length);
                        for (var g = 0; g < n.series[d].length; g++) {
                            var f = l[d][g];
                            null !== f && u.isNumber(f) ? (r = Math.max(r, c[d][g]), e = Math.min(e, h[d][g]), i = Math.max(i, h[d][g]), "candlestick" === this.w.config.chart.type && (r = Math.max(r, n.seriesCandleO[d][g]), r = Math.max(r, n.seriesCandleH[d][g]), r = Math.max(r, n.seriesCandleL[d][g]), i = r = Math.max(r, n.seriesCandleC[d][g])), u.isFloat(f) && (f = u.noExponents(f), n.yValueDecimal = Math.max(n.yValueDecimal, f.toString().split(".")[1].length)), o > h[d][g] && h[d][g] < 0 && (o = h[d][g])) : n.hasNullValues = !0
                        }
                    }
                    return "rangeBar" === s.chart.type && n.seriesRangeStart.length && "datetime" === s.xaxis.type && (o = e), {
                        minY: o,
                        maxY: r,
                        lowestY: e,
                        highestY: i
            ...
            return a(t, [{
                ...
                value: function (t, e) {
                    var i = this.w.config,
                        a = this.w.globals,
                        s = {};
                    return this.isFormat2DArray() ? s = this.handleRangeDataFormat("array", t, e) : this.isFormatXY() && (s = this.handleRangeDataFormat("xy", t, e)), a.seriesRangeStart.push(s.start), a.seriesRangeEnd.push(s.end), "datetime" === i.xaxis.type && a.seriesRangeBarTimeline.push(s.rangeUniques), s
                }
            }, {
                ...
                value: function (t) {
                    ...
                    else if (this.fallbackToCategory) i.labels = i.labels[0], i.seriesRangeBarTimeline.length && (i.seriesRangeBarTimeline.map(function (t) {
                        t.forEach(function (t) {
    ...
    var nt, rt, ot = function () {
        ...
        lt = function () {
            function t(i) {
                e(this, t), this.ctx = i, this.w = i.w;
                var a = this.w;
                this.anim = new f(this.ctx), this.xaxisLabels = a.globals.labels.slice(), this.animX = a.config.grid.xaxis.lines.animate && a.config.chart.animations.enabled, this.animY = a.config.grid.yaxis.lines.animate && a.config.chart.animations.enabled, this.isTimelineBar = "datetime" === a.config.xaxis.type && a.globals.seriesRangeBarTimeline.length, a.globals.timelineLabels.length > 0 && (this.xaxisLabels = a.globals.timelineLabels.slice()), a.globals.invertedTimelineLabels.length > 0 && (this.xaxisLabels = a.globals.invertedTimelineLabels.slice())
            }
            return a(t, [{
                key: "drawGridArea",
                value: function () {
                ...
                value: function () {
                    ...
                    if (!t.globals.isBarHorizontal || this.isTimelineBar) {
                        if (r = this.xaxisLabels.length, t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show) {
                            var h, c = t.globals.padHorizontal,
                                d = t.globals.gridHeight;
                            if (t.globals.timelineLabels.length || t.globals.invertedTimelineLabels.length)
                                for (var u = 0; u < r; u++) {
                                    if (c = this.xaxisLabels[u].position, h = this.xaxisLabels[u].position, t.config.grid.xaxis.lines.show && c > 0 && c < t.globals.gridWidth) {
                                    ...
                                    for (var x = r, b = 0; b < x; b++) {
                                        ...
                                        if (t.config.grid.xaxis.lines.show) {
                                            ...
                                            v.node.classList.add("apexcharts-gridline"), n.add(v), this.animX && this.animateLine(v, {
                                                x1: 0,
                                                x2: 0
                                            }, {
                                                x1: c,
                        ...
                        if (t.config.grid.yaxis.lines.show) {
                            ...
                            for (var S = 0; S < A; S++) {
                                ...
                                s.add(C), C.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(C, {
                                    y1: y + 20,
                                    y2: w + 20
                                }, {
                                    y1: y,
                        ...
                        if (r = o, t.config.grid.xaxis.lines.show || t.config.xaxis.axisTicks.show)
                            for (var L, P = t.globals.padHorizontal, z = t.globals.gridHeight, T = 0; T < r + 1 && (L = P = P + t.globals.gridWidth / r + .3, T !== r - 1); T++) {
                                if (t.config.grid.xaxis.lines.show) {
                        ...
                        if (t.config.grid.yaxis.lines.show)
                            for (var M = 0, I = 0, X = t.globals.gridWidth, Y = 0; Y < t.globals.dataPoints + 1; Y++) {
                                ...
                                s.add(F), F.node.classList.add("apexcharts-gridline"), this.animY && this.animateLine(F, {
                                    y1: M + 20,
                                    y2: I + 20
                                }, {
                                    y1: M,
                    ...
                    return this.isTimelineBar && (o = t.globals.labels.length), this.drawGridBands(a, r, o), {
                        el: a,
            ...
            return a(t, [{
                ...
                value: function (t) {
                    var e = t.shared,
                        ...
                        h = t.y2,
                        c = this.w;
                    void 0 !== c.config.tooltip.custom ? Array.isArray(c.config.tooltip.custom) ? this.handleCustomTooltip({
                        i: n,
                        j: o,
                        y1: l,
                        y2: h,
                ...
                value: function (t) {
                    ...
                    n && l[e] && (l = r.config.tooltip.custom[e]), o.innerHTML = l({
                        ctx: this.ctx,
            ...
            return a(t, [{
                ...
                value: function (t) {
                    ...
                    if (null === r.tooltip && (r.tooltip = n.globals.dom.baseEl.querySelector(".apexcharts-tooltip")), n.config.tooltip.shared || (n.globals.comboChartsHasBars ? r.tooltipPosition.moveXCrosshairs(l + i / 2) : r.tooltipPosition.moveXCrosshairs(l)), !r.fixedTooltip && (!n.config.tooltip.shared || n.globals.isBarHorizontal && r.hasBars())) {
                        var p = n.globals.isMultipleYAxis ? n.config.yaxis[x] && n.config.yaxis[x].reversed : n.config.yaxis[0].reversed;
                        ...
                        !p || n.globals.isBarHorizontal && r.hasBars() || (c = c + u - 2 * (n.globals.series[e][g] < 0 ? u : 0)), r.tooltipRect.ttHeight + c > n.globals.gridHeight ? (c = n.globals.gridHeight - r.tooltipRect.ttHeight + n.globals.translateY, o.style.top = c + "px") : o.style.top = c + n.globals.translateY - r.tooltipRect.ttHeight / 2 + "px"
                    }
                }
            }, {
                key: "getBarTooltipXY",
                value: function (t) {
                    ...
                    if (d.contains("apexcharts-bar-area") || d.contains("apexcharts-candlestick-area") || d.contains("apexcharts-rangebar-area")) {
                        ...
                        a.globals.comboCharts && (r = parseInt(u.parentNode.getAttribute("data:realIndex"))), n.tooltipLabels.drawSeriesTexts({
                            ttItems: i.ttItems,
                            i: r,
                            j: s,
            ...
            return o(i, mt), a(i, [{
                ...
                value: function (t) {
                    ...
                    if (a.config.yaxis.forEach(function (t, e) {
                            d.push(a.globals.yAxisScale[e].niceMax - n.yRatio[e] * s.startY), g.push(a.globals.yAxisScale[e].niceMax - n.yRatio[e] * s.endY)
                ...
                switch (t[0]) {
                    ...
                    case "A":
                        t = (e = function (t, e) {
                            ...
                            i = new SVG.Point((F.x - R.x) / 2, (F.y - R.y) / 2).transform((new SVG.Matrix).rotate(E)), (a = i.x * i.x / (z * z) + i.y * i.y / (T * T)) > 1 && (a = Math.sqrt(a), z *= a, T *= a);
                            s = (new SVG.Matrix).rotate(E).scale(1 / z, 1 / T).rotate(-E), F = F.transform(s), R = R.transform(s), n = [R.x - F.x, R.y - F.y], o = n[0] * n[0] + n[1] * n[1], r = Math.sqrt(o), n[0] /= r, n[1] /= r, l = o < 4 ? Math.sqrt(1 - o / 4) : 0, M === I && (l *= -1);
